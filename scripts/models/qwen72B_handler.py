...
class Qwen72BHandler(BaseModelHandler):
    ...
    def generate(self, image_path: str, sys_prompt: str = None, user_prompt: str = None, extraction: bool = True) -> Dict:
        ...
        completion = client.chat.completions.create(
            model="qwen2.5-vl-72b-instruct",  # Using qwen-vl-max as an example, you can change the model name as needed. Model list:  https://www.alibabacloud.com/help/model-studio/getting-started/models
            messages=[
                {
                    "role": "system",
