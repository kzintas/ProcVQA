...
class Qwen32BHandler(BaseModelHandler):
    """Handler for Qwen-VL-Max model."""
    
    def __init__(
        self, 
        model_id: str = "qwen2.5-vl-32b-instruct",
    ...
    def generate(self, image_path: str, sys_prompt: str = None, user_prompt: str = None, extraction: bool = True) -> Dict:
        """
        Generate event response using the qwen2.5-vl-32b-instruct model.
        ...
        completion = client.chat.completions.create(
            model="qwen2.5-vl-32b-instruct",  # Using qwen-vl-max as an example, you can change the model name as needed. Model list:  https://www.alibabacloud.com/help/model-studio/getting-started/models
            messages=[
                {
                    "role": "system",
